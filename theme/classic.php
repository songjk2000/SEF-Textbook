...
<head>
    ...
    <style type="text/css">
        ...
        .list-wrapper{width:80%;margin:0 auto;position:relative;border-radius:15px;}
        .list-container{min-height:400px;background-color:#FFFFFF;position:relative;overflow:hidden;border-radius:15px;}
        ...
        .table-header{margin:0;border:0 none;padding:30px 60px;text-align:left;font-weight:400;color:#000;background-color:#FFFFFF;word-break: break-all;word-wrap: break-word;}
        .list-body-container{position:relative;left:0;overflow-x:hidden;overflow-y:auto;box-sizing:border-box;background:#FFFFFF}
        .more-disk{margin:0;border:0 none;padding:30px 30px;text-align:left;font-weight:400;color:#000;background-color:#FFFFFF;white-space:nowrap;overflow:auto;}
        ...
        .list-table td,.list-table th{padding:0 15px;text-align:left}
        .list-table .size,.list-table .updated_at{text-align:center;}
...
<?php } ?>
                                ...
                                document.getElementById('upfile_td1_'+tdnum).innerHTML='<font color="green"><?php if (!$_SERVER['admin']) { ?><br><?php } ?><br><?php echo getconstStr('UploadComplete'); ?></font>';
